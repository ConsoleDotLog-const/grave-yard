...
const door = new THREE.Mesh(
    new THREE.PlaneBufferGeometry(2.4,2.2, 100, 100),
    new THREE.MeshStandardMaterial({
...
for(let i = 0; i < 50; i++){
    ...
    const angleY = Math.cos(angle) * radius

    
const grave = new THREE.Mesh(graveGeo,graveMat)

grave.position.set(angleX, 0.3, angleY)
...
const tick = () =>
{
    ...
    ghost3.position.y = Math.sin(elapsedTime * 3)  + Math.cos(elapsedTime * 3)
